...
class VOCDataset(torch.utils.data.Dataset):
    ...
    #                'motorbike', 'd00', 'd10',
    #                'd20', 'd40', 'train', 'tvmonitor')
    # class_names = ('__background__', 'longitudinal crack', 'transverse crack', 'craze', 'hole')
    class_names = (
    '__background__','safety','risk','none')
