...
def main():
    ...
    parser.add_argument(
        ...
        default='outputs/vgg_ssd300_voc0712/model_final.pth',
        type=str,
    )
    ...
    model = evaluation(cfg, ckpt=args.ckpt, distributed=distributed)
    input_temp = torch.randn(1,3,300,300)
    flops,params = profile(model,inputs=(input_temp,))
